...
function send(data){
    $.ajax({
        // 這邊用get type
        type: "get",
        // api url - google appscript 產出的 url，sheet：https://docs.google.com/spreadsheets/d/10nULFO70o-n7d4DHG_lm_TW7qBypRoQwRhEwq5VHHTk/edit#gid=0
        url: "https://script.google.com/macros/s/AKfycby2DiW4ldob4D8svwIcZoWGxJOCQZXvqaNmyHtqdZNLgj6DudjJ/exec",
        // 剛剛整理好的資料帶入
        data: data,
        // 資料格式是JSON 
        dataType: "JSON",
